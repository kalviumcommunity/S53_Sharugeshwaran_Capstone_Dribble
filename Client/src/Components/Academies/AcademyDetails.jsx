...
console.log(data.State);
    return (
        <div style={{color: "black",display: "flex",justifyContent: "center",alignItems: "center",height: "100vh",fontFamily: "'Inter',sans-serif",padding: ""}}>
            <div style={{backgroundColor: "white",display: "flex",alignItems: "center",flexDirection: "column",padding: "3%",borderRadius: "30px",width: "60vw"}}>
                ...
                <p style={{fontSize: "1.5rem"}}>{data.name}</p><a href={data.social} style={{color: "blue"}}>visit</a>
                </div>
