  ...
  return (
    <div style={{display: "flex",flexDirection: "column",justifyContent: "center"}}>
        ...
        <div style={{display: "flex",width: '100%',justifyContent: "space-around",marginTop: "10vh"}}>
                ...
                <div style={{fontSize: "2.05rem",color: "",fontWeight: "700",lineHeight: "55px",fontFamily: "Inter",width: "30vw"}}>
                    {data.name}
                </div>
            ...
            <div className='modulesListing' style={{padding: "20vh 0",display: "grid", gridTemplateColumns: "repeat(3,1fr)",gridColumnGap: "12vw",justifyContent: "space-around",gridRowGap: "7vh"}}>
                {data.modules.map((e,i) => {
                    return(
                        <motion.div key={i} style={{height: "35vh",backgroundColor: "white",width: "20vw",display: "flex",alignItems: "center",marginBottom: "5vh",justifyContent: "center", textAlign: "center", padding: "3%",color: "white",borderRadius: "20px",
                        background: "linear-gradient(135deg, #C17457, #EB25D2)",boxShadow: "2px 2px 22px 0px gray"}}onClick={() => {
